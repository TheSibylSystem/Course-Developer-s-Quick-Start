!(function () {
  ...
  function b(a) {
    ...
    if (((this.length = 0), a))
      if (
        ('string' == typeof a && (a = this.find(a)),
        a.nodeType || a === a.window)
      )
  ...
  (b.extend = a),
    (b.contains = function (a, b) {
      do if (((b = b.parentNode), b === a)) return !0;
      while (b);
      return !1;
    }),
    ...
    a(b.prototype, {
      ...
      hasClass: function (a) {
        return this[0]
          ? new RegExp('(^|\\s+)' + a + '(\\s+|$)').test(this[0].className)
          : !1;
      },
      addClass: function (a) {
      ...
      removeClass: function (a) {
        for (
          var b, c = new RegExp('(^|\\s+)' + a + '(\\s+|$)'), d = this.length;
          d;
    ...
    return (
      a.extend(b.prototype, {
        ...
        slide: function (a, b) {
          ...
          if (f !== a && 1 !== this.num) {
            if (
              (b || (b = this.options.transitionSpeed), this.support.transition)
            ) {
              for (
          ...
          if (!(d.length > 1 || (e && 1 !== e)))
            if (
              ...
              void 0 === this.isScrolling &&
                (this.isScrolling =
                  this.isScrolling ||
                  Math.abs(b) < Math.abs(this.touchDelta.y)),
              this.isScrolling)
            )
