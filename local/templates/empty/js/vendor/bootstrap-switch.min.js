        ...
        return (
          ...
          (t.prototype.inverse = function (t) {
            ...
            return 'undefined' == typeof t
              ...
              : ((t = !!t),
                this.$wrapper[t ? 'addClass' : 'removeClass'](
                  '' + this.options.baseClass + '-inverse'
                ),
                (s = this.$on.clone(!0)),
                (e = this.$off.clone(!0)),
                this.$on.replaceWith(e),
                this.$off.replaceWith(s),
                (this.$on = e),
                (this.$off = s),
                (this.options.inverse = t),
                this.$element);
          }),
          ...
          (t.prototype._containerPosition = function (t, s) {
            return (
                ...
                return function (e) {
                  ...
                  if (t._dragStart)
                    return (
                      ...
                      t._dragEnd
                        ? ((s = t._dragEnd > -(t._handleWidth / 2)),
                          (t._dragEnd = !1),
                          t.state(t.options.inverse ? !s : s))
                ...
                (function (e) {
                  return function (s) {
                    return (
                      s.preventDefault(),
                      s.stopImmediatePropagation(),
                      s.target === t[0] ? e.toggleState() : void 0
                    );
                  };
                })(this)
              )
          ...
          (t.prototype._getClasses = function (t) {
            ...
            for (i = [], o = 0, n = t.length; n > o; o++)
              (s = t[o]), i.push('' + this.options.baseClass + '-' + s);
            return i;
          }),
          t
        );
        ...
        return (
          ...
          this.each(function () {
            ...
            return (
              ...
              a || t.data('bootstrap-switch', (a = new i(this, o))),
              'string' == typeof o ? (n = a[o].apply(a, s)) : void 0
            );
          }),
          n
        );
      }),
      (e.fn.bootstrapSwitch.Constructor = i),
      (e.fn.bootstrapSwitch.defaults = {
        state: !0,
        size: null,
        animate: !0,
